...
class CancelMixedDexTradeWithoutCancelTest(MasterTestFramework):
    ...
    def test_cancel_traditional_trade(self):
        ...
        After the test A1 should have 50.0 TMSC and 13.5 TMSC reserved."""
        entity_a1 = self.entities[1]
...
if __name__ == '__main__':
    CancelMixedDexTradeWithoutCancelTest().main()
